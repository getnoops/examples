module github.com/getnoops/examples/diary-api
...
require (
	...
	github.com/aws/aws-sdk-go-v2/feature/rds/auth v1.4.0 // indirect
	...
	github.com/contextcloud/eventstore v0.3.25 // indirect
